...
export default function UserPanel() {
 ...
 <div className="brand-card-level-2 p-8 max-w-md w-full text-center">
 ...
 <h2 className="text-[32px] font-bold text-[#191c1d] font-heading mb-2 tracking-tight">Order Placed!</h2>
 <p className="text-[#42493e] mb-8 font-sans">Please show this code at the counter</p>
 <div className="bg-[#f1f3f0] rounded-[var(--radius-xl)] py-6 mb-8 border border-[var(--color-brand-border)]">
 <span className="text-[40px] font-heading font-bold tracking-widest text-[var(--color-brand-primary)]">{orderComplete.code}</span>
 </div>
 <button 
 onClick={() => setOrderComplete(null)}
 className="brand-btn-primary w-full py-4 text-[16px]"
 >
 Start New Order
 </button>
 </div>
 ...
 {products.length === 0 ? (
 <div className="col-span-full text-center py-12 text-[#72796e]">
 ...
 <span className="text-[#72796e] text-sm font-sans">No Image</span>
 )}
 </div>
 <div className="p-5">
